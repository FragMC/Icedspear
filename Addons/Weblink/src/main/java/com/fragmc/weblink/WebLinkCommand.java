...
public class WebLinkCommand implements CommandExecutor, TabCompleter {
    ...
    private void handleLink(Player player) {
        ...
        player.sendMessage("");
        player.sendMessage(ChatColor.WHITE  + "Your link code is: "
                + ChatColor.GREEN + ChatColor.BOLD + code);
        player.sendMessage("");
    ...
    private void handleUnlink(Player player) {
        ...
        if (plugin.getLinkManager().unlinkAccount(player.getUniqueId())) {
            player.sendMessage(ChatColor.GREEN + "✓ Your account has been unlinked successfully!");
        } else {
            player.sendMessage(ChatColor.RED + "Failed to unlink. Please try again.");
        }
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        for (String sub : List.of("link", "unlink", "status")) {
